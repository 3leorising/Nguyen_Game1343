...
public class InputPoller : MonoBehaviour
{
    ...
    void Awake()
    {    
        //singleton lesson: if theres another instance of this reference, get rid of it
        if (reference != null)
        {
        ...
        reference = this;
        //this code is in DontDestroyOnLoad.cs
    ...
    public InputData GetInputP0()
    {
        ...
        if (kb != null)
        {
            ...
            input.buttonWest = kb.zKey.wasPressedThisFrame;
